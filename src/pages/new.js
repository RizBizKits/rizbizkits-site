...
export default () => (
    ...
    <div class="new">
        ...
        <nav class="hire-me">
            Hey, I'm available for hire. Read More.
        </nav>
            ...
            <div class="werk__container container">
                ...
                <div class="werk__content--wrapper">
                    ...
                    <div class="werk__content">
                        ...
                        {/* <a href="mailto:rizwana.akmal@hotmail.com" target="_blank" class="news__button--email news__button">Peek into my portfolio</a>
                        <a href="mailto:rizwana.akmal@hotmail.com" target="_blank" class="news__button--email news__button">Peek into my portfolio</a> */}
                    </div>
                </div>
            </div>
